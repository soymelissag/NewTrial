...
## OT Neue Montreal — Free for Personal Use v1.0
Pangram Pangram × OffType. The free release ships only the *Squeezed* widths;
`css/neue-montreal.css` maps them to two families:

| CSS family | Width | Weights |
|---|---|---|
...
## Others
`Dandelion-Regular.otf`, `TAYBirdie-Regular.otf`, `TAYMisprint-Regular.otf`.
